    ...
    return (
      <Tooltip content="Upload complete" side="top" delay={100}>
        <motion.span
          ...
          className="grid size-9 shrink-0 place-items-center rounded-xl text-success-deep"
        >
...
function AttachmentRow({
  ...
  const uploadProgress = (
    <motion.span
      ...
      className="pointer-events-none absolute inset-0 -z-10 origin-left bg-success/25"

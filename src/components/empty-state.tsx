...
export function EmptyState({
  ...
  return (
    <div className="bg-card bg-tint-wash border-hairline-strong/60 flex min-h-64 flex-col items-center justify-center gap-4 rounded-2xl border border-dashed p-8 text-center">
      {Icon ? (

...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        "data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0 bg-ink/40 fixed inset-0 z-50 duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] data-[state=closed]:duration-150 motion-reduce:animate-none",
        className,
      )}
      {...props}
    />
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn("text-foreground text-display-sm", className)}
      {...props}
    />
  );
}

...
8. [`F8-05-ai-models-pricing-credits.md`](F8-05-ai-models-pricing-credits.md) — catálogo de 3 modelos, precio ×2 por token, créditos prepagados y pospago en factura (planeado)
9. [`F9-01-user-profile.md`](F9-01-user-profile.md) — vista de perfil por panel (cuenta, seguridad, dispositivos, asistente, facturación IA) desde el avatar del header en `/{panel}/settings/profile` (implementado; avatar D2 pendiente)

...
9. [`F9-01-user-profile.md`](F9-01-user-profile.md) — vista de perfil por panel (cuenta, seguridad, dispositivos, asistente, facturación IA) desde el avatar del header (planeado; depende de F8-05)
